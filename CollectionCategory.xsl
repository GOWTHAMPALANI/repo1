...
xmlns:xsl = "http://www.w3.org/1999/XSL/Transform">  
	...
	<xsl:template match = "/">   
		...
		<html>   
			<head>
				<title>Collection Tracker Category </title>
			...
			<body>  
				...
				<div class="container" style= "max-width:1250px;background-color:border:2px solid black;">
					<table class="table table-hover table-border"  style="background-color:#FFF;border:2px solid black;">
						<div class="header"><h2  style="color:black;text-align:center;background-color:;">CollectionCategory-<i><script language="Javascript">
